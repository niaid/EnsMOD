...
# Remove any row (genes/proteins) with one or more missing values ("NaN") 
...
pdf(file="./app/www/EnsMODoutputs/Density_plot.pdf")
plotDensities(input_data_nna, main="Densities of the Abundance Values for each Sample", legend = "topright") 
dev.off()
...
# Also save a copy as PDF
pdf(file="./app/www/EnsMODoutputs/Hierachical_clustering.pdf")
plot(hc.res_a)
dev.off()
...
pdf(file="./app/www/EnsMODoutputs/Robust_Sparse_PCA.pdf")
diagPlot(resR0, title = "Robust PCA (robpca)", pch = 17, col="red", labelOut = TRUE, id = 5)
dev.off()
...
# Also save it as a pdf file
pdf(file="./app/www/EnsMODoutputs/PcaGrid.pdf")
diagPlot(pc, title = "Robust PCA (PcaGrid)", pch = 17, col="red", labelOut = TRUE, id = 5)
dev.off()
...
write.csv(intersect(pcOutliers, rosOutliers), file="./app/www/EnsMODoutputs/Outliers_identified_by_both_RobustPCAs.csv")
```
<br>
...
write.csv(intersect(hcOutliers, rosOutliers), file="./app/www/EnsMODoutputs/Outliers_identified_by_HierarchicalClustering.csv")
...
# Save the outlier to a file
write.csv(intersect(intersect(hcOutliers, rosOutliers), pcOutliers), file="./app/www/EnsMODoutputs/Outliers_identified_by_EnsembleMethods.csv")
```
<br>
